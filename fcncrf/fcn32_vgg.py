...
class FCN32VGG:
    ...
    def build(self, rgb, num_classes=20, keep_probability=1.0, random_init_fc8=False,
              debug=False):
        """
        ...
        self.fc6 = tf.nn.dropout(self.fc6, keep_probability)

        self.fc7 = self._fc_layer(self.fc6, "fc7")
        
        self.fc7 = tf.nn.dropout(self.fc7, keep_probability)
        ...
        self.upscore=CrfRnnLayer(image_dims=(256, 256),
                         num_classes=2,
                         theta_alpha=160.,
                         theta_beta=3.,
                         theta_gamma=3.,
                         num_iterations=5,
                         name='crfrnn')([self.upscore, bgr])
